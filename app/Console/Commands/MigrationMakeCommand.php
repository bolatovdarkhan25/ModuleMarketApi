...
class MigrationMakeCommand extends MigrateMakeCommand
{
    ...
    protected $signature = 'make:migration {name : The name of the migration}
        ...
        {--data_type= : Data type for characteristic value}';
    ...
    protected function writeMigration($name, $table, $create)
    {
        ...
        $type      = (string) $this->option('type');
        $dataType  = (string) $this->option('data_type');
        ...
        $file = $this->creator->create($name, $this->getMigrationPath(), $table, $create, $stubType, $contract, $dataType);
