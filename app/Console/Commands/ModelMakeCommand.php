...
{
    private MakeModelCommandService $makeModelCommandService;

    public function __construct(Filesystem $files, MakeModelCommandService $makeModelCommandService)
    {
        $this->makeModelCommandService = $makeModelCommandService;
    ...
    protected function getStub(): string
    {
        ...
        $this->makeModelCommandService->relocateStubFiles($isBoosted);
