...
class ModelMakeCommand extends GeneratorCommand
{
    ...
    protected function createMigration()
    {
        ...
        $dataType = $this->option('data_type');
    ...
    protected function getOptions(): array
    {
        return [
            ...
            ['type', 't', InputOption::VALUE_OPTIONAL, 'Type of autogenerated models (good or char)'],
            ['data_type', 'd', InputOption::VALUE_OPTIONAL, 'Data type for characteristic value']
        ];
    }
}
